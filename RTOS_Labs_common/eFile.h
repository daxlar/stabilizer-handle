...
/**
 * @details API for interpreter to print out eFile Directory
 * @param  none
 * @return void, errors are printed out where they occur, in eFile.c
 * @brief  print out eFileDirectory
 */
void eFile_PrintDirectory(void); 

/**
 * @details API for interpreter to print out eFile file
 * @param  fileName to print
 * @return void, errors are printed out where they occur, in eFile.c
 * @brief  print out eFile file
 */
void eFile_PrintFile(char* fileName); 

/**
 * @details API for interpreter to delete specified eFile file
...
/**
 * @details API for interpreter to format disk
 * @param  none
 * @return void, errors are printed out where they occur, in eFile.c
 * @brief  format disk
 */
...
/**
 * @details API for interpreter to create file on eDisk
 * @param  fileName to create
 * @return void, errors are printed out where they occur, in eFile.c
 * @brief  create file with name fileName
 */
...
/**
 * @details API for interpreter to write string to file on eDisk
 * @param  fileName to create, string to write to file
 * @return void, errors are printed out where they occur, in eFile.c
 * @brief  write stringToWrite to file fileName
 */
void eFile_WriteToFile(char* fileName, char* stringToWrite);

/**
 * @details API for interpreter to unmount on eDisk
 * @param  none
 * @return void, errors are printed out where they occur, in eFile.c
 * @brief  unmount FS
 */
