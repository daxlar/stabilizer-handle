...
Sema4Type InCharAvailable;
Sema4Type OutCharAvailable;
...
void UART_Init(void){
  ...
  NVIC_EN0_R = NVIC_EN0_INT5;           // enable interrupt 5 in NVIC
	...
	OS_InitSemaphore(&InCharAvailable, 0);
	OS_InitSemaphore(&OutCharAvailable, 0);
}
